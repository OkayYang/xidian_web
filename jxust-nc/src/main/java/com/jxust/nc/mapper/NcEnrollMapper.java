 ...
 * @date 2023-04-03
 */
public interface NcEnrollMapper 
{
    /**
     * 查询报名记录
     * 
     ...
     * @return 结果
     */
    public int deleteNcUserByUids(Long[] enrollIds);
    
    /**
     * 批量新增用户管理
     * 
     * @param ncUserList 用户管理列表
     * @return 结果
     */
    public int batchNcUser(List<NcUser> ncUserList);
     ...
     * @return 结果
     */
    public int deleteNcUserByUid(Long enrollId);
